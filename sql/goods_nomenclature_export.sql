...
DROP FUNCTION IF EXISTS django.goods_nomenclature_export(text,  character varying);

CREATE OR REPLACE FUNCTION django.goods_nomenclature_export(pchapter text, key_date character varying)
