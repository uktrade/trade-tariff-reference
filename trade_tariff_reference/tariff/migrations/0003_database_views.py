...
BREXIT_VALIDITY_START_DATE = datetime(2019, 3, 29, 0, 0, 0)  # datetime(2018, 1, 1, 0, 0, 0) - Time from database views
BREXIT_VALIDITY_END_DATE = datetime(2019, 12, 31, 0, 0, 0)


def load_database_views(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tariff', '0002_currentmeasures_meursingcomponents'),
    ]

    operations = [
        migrations.RunPython(load_database_views, migrations.RunPython.noop),
    ]
